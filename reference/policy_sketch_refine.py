...
def refine(ground_mdp, ground_state, abstract_mdp, abstract_state, sketched_solution, expansion_strategy, gamma):
    ...
    logging.info("---- Enabled point of interest abstract state expansion: [abstract_states=%s]", point_of_interest_abstract_state_set)
...
def solve(ground_mdp, ground_state, abstract_mdp, abstract_state, expansion_level, gamma):
    sketched_solution = sketch(abstract_mdp, gamma)
    refined_solution = refine(ground_mdp, ground_state, abstract_mdp, abstract_state, sketched_solution, expansion_level, gamma)
    return refined_solution